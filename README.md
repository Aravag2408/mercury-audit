...
1. Can adversarial prompts extract verbatim training conversations from the fine-tuned model?
2. How do we distinguish base model pre-training knowledge from fine-tuning memorization?
3. Does the chatbot's intent classifier incidentally limit memorization exposure as a side effect?
4. What is the real-world privacy risk given that patient records are Synthea-generated (synthetic)?

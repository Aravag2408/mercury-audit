  ...
  return (
    <>
      ...
      >
         ...
         * Mercury Family) require saved personal data and would otherwise
        ...
        <nav className="flex-1 overflow-y-auto space-y-0.5">
          ...
          {isAuthenticated && (
            <>
              ...
              <NavItem icon={Stethoscope} label={t("nav_dashboard", language)} active={activeNav === "health-dashboard"} onClick={() => setActiveNav("health-dashboard")} collapsed={collapsed} />
              ...
              <NavItem icon={UsersRound} label="Mercury Family" active={activeNav === "family-health"} onClick={() => setActiveNav("family-health")} collapsed={collapsed} />
            </>
          )}
              ...
              {bottomMenuOpen && !collapsed && (
                <div className="absolute bottom-full left-0 right-0 mb-2 bg-surface-1 border border-line/60 rounded-2xl shadow-card overflow-hidden animate-in fade-in slide-in-from-bottom-4 duration-200 z-50">
                  <div className="p-2 space-y-0.5">
                    ...
                    <MenuItem icon={Share2} label="Share Mercury" onClick={() => { if (navigator.share) navigator.share({ title: "Mercury", url: window.location.origin }); }} />
                    <MenuItem icon={Info} label="About Mercury" detail="v1.0" onClick={() => navTo("settings")} />

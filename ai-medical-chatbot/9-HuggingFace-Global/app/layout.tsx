...
export const metadata: Metadata = {
  title: "Mercury — your worldwide medical assistant",
  description:
    "Tell Mercury what's bothering you. Instant, private, multilingual health guidance aligned with WHO, CDC, and NHS.",
  keywords: ["medical AI", "healthcare", "chatbot", "telemedicine", "WHO", "CDC"],
  authors: [{ name: "Mercury Team" }],

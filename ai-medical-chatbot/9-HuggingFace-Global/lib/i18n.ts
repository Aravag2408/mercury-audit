...
export const translations: Record<string, Record<string, string>> = {
  en: {
    ...
    ask_example_1: "I may have been exposed to an STI",
    ask_example_2: "What are the symptoms of chlamydia?",
    ask_example_3: "How do I get tested for HIV?",
    ask_example_4: "What is PrEP and how does it work?",
    ask_type: "Type",
    ask_speak: "Speak",
    ...
    home_hero_eyebrow: "Private · Confidential · Non-judgmental",
    home_hero_title: "Your sexual health questions, answered.",
    home_hero_subtitle:
      "Mercury gives you private, CDC & WHO-backed guidance on STIs, HIV, testing, and treatment — no judgment, no waiting rooms.",

    ask_hero_title: "I'm here to help.",
    ask_hero_subtitle:
      "Describe your symptoms or question in your own words. Everything you share is private and confidential.",

    ask_placeholder_rotate_1: "I noticed unusual discharge. Could it be an STI?",
    ask_placeholder_rotate_2: "What's the difference between PrEP and PEP?",
    ask_placeholder_rotate_3: "How soon after exposure should I get tested?",
    ...
    trust_reviewed: "CDC · WHO STI guidelines",
    trust_private: "Private & confidential",
